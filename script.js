const defaultTranslations = {
  bg: {
    ...
    "hero-subtitle":
      "Автокомплекси Маями предлага следните услуги: автосервиз, смяна на гуми, тенекеджийски и бояджийски услуги, автомивка и детайлинг, автотапицерски услуги и други",
    ...
    "svc-cosmo-f3":
      "Нанасяне на защита с керамично покритие, полагане на защитно фолио и други",
    ...
    "svc-uph-desc":
      "Интериорни ремонти, претапициране на седалки, волан и панели",
    ...
    "svc-ins-desc":
      "Консултации и сключване на всички видове автомобилни и други застраховки, включително:",
    ...
    "about-title": "За нас",
    "about-text-1":
      "Автокомплекси Маями е утвърдена верига от премиум автосервизи в София от 2008 г. Към днешна дата сервизите предлагат пълна гама услуги за автомобили, включващи сервизна дейност, техническа поддръжка, годишни технически прегледи, автомивка, автокозметика, детейлинг, тунинг, застраховки и продажба на автомобили.",
    "about-text-2":
      "Със своите над 15 години опит, опитни механици и специалисти в своята дейност, верига Авто Маями се е превърнала в предпочитан партньор за частни клиенти, корпоративни автопаркове и автомобилни фенове.",

    // Insurance
    "insurance-title": "Доверен сервиз",
    "insurance-text":
      "Сервизите на Auto Miami работят със следните застрахователи: ",

    // Gallery
    "gallery-title": "Нашата Галерия",
    "gallery-subtitle":
      "Разгледайте снимки от нашите автокомплекси и работата ни",
    "gallery-sub-subtitle":
      "Натиснете някоя снимка за да я разгледате по-подробно",

    // Pricing
    "pricing-title": "Цени",
    "pricing-text":
      "Поради голямото разнообразие от услуги и специфики на автомобилите, крайната цена се определя след оглед и консултация. Нашите специалисти ще ви препоръчат най-доброто решение и ще изготвят индивидуална оферта.",
    "pricing-subtitle":
      "Каним Ви в най-близкия автосервиз за консултация и оферта",
    ...
    "complex-2-address":
      'кв. Кръстова вада, ул. „Манфред Вьорнер" 9, гр. София',
    ...
    "documents-main-text":
      "АВТОКОМПЛЕКСИ МАЯМИ ООД сключи договор за предоставяне на безвъзмездна финансова помощ по процедура BG16RFPR001-1.004 „Подкрепа за семейните предприятия, предприятията от творческите индустрии и занаятите“ по Програма „Конкурентоспособност и иновации в предприятията“ 2021-2027.",
    "documents-download-link": "Свалете пълното съобщение от тук",
    "documents-other-title": "Други документи:",

    // Footer
    "footer-description":
      "Вашият доверен партньор за всички автомобилни нужди в София.",
  ...
  en: {
    ...
    "hero-subtitle":
      "Auto Complexes Miami offers the following services: car repair, tire change, bodywork and painting services, car wash and detailing, auto upholstery services and more",
    ...
    "svc-cosmo-f3":
      "Applying ceramic coating protection, applying protective film and more",
    ...
    "svc-uph-desc":
      "Interior repairs, reupholstery of seats, steering wheel, panels",
    ...
    "svc-ins-desc":
      "Consultations and inclusion of all automobile and other types of insurance, including:",
    ...
    "about-text-1":
      "Auto complexes Miami is a premium car service chain in Sofia since 2008. Today, our centers offer a full range of automotive services including maintenance, technical support, annual technical inspections, car wash, auto detailing, tuning, insurance, and car sales.",
    "about-text-2":
      "With over 15 years of experience and skilled mechanics and specialists, Auto Miami has become a preferred partner for private clients, corporate fleets, and automotive enthusiasts.",

    // Insurance
    "insurance-title": "Trusted Service",
    "insurance-text":
      "Auto Miami Services work with the following insurance providers: ",
    ...
    "pricing-text":
      "Due to the great variety of services and vehicle specifics, the final price is determined after inspection. Our specialists will recommend the best solution and prepare a transparent offer.",
    "pricing-subtitle":
      "We invite you to the nearest auto complex for consultation and individual offer",
    ...
    "documents-main-text":
      'AutoComplex Miami Ltd. signed a contract for providing non-refundable financial assistance under procedure BG16RFPR001-1.004 "Support for family enterprises, enterprises from the creative industries and crafts" under the "Competitiveness and Innovation in Enterprises" Program 2021-2027.',
    "documents-download-link": "Download the full announcement here",
    "documents-other-title": "Other documents:",

    // Footer
    "footer-description":
      "Your trusted partner for all automotive needs in Sofia.",
...
function initMobileDrawerSecondary() {
  ...
  optionsAnchor.addEventListener("click", () => {
    const isOpen = drawer.classList.contains("open");
    if (isOpen) closeDrawerSecondary();
    else openDrawer();
  });
  ...
  links.forEach((link) =>
    link.addEventListener("click", () => closeDrawerSecondary()),
  );

  document.addEventListener("keydown", (e) => {
    if (e.key === "Escape" && drawer.classList.contains("open"))
      closeDrawerSecondary();
  });
}
